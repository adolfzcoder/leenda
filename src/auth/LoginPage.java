...
public class LoginPage extends javax.swing.JFrame {
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(btnLogin, javax.swing.GroupLayout.PREFERRED_SIZE, 25,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(btnSignUp, javax.swing.GroupLayout.PREFERRED_SIZE, 25,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(41, 41, 41)
                                .addComponent(jLabel1)
    ...
    private void btnLoginOnClick(java.awt.event.ActionEvent evt)
            throws FileNotFoundException, UnsupportedLookAndFeelException {// GEN-FIRST:event_btnLoginOnClick
        ...
        if (email.equals("")) {
            ...
            JOptionPane.showMessageDialog(this, "Password must be entered.", "Password missing",
                    JOptionPane.ERROR_MESSAGE);
            // Validate password against the regex pattern for letters, digits, and special
            // characters
        }
        // Proceed to authenticate the user
        else {
            AuthFunctions.login(email, password, this);
        }
