package lendeefs.auth;
import databaseconnection.LoginService;
...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void btnLoginOnClick(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginOnClick
        String emailRegex = "^[\\w-\\.]+@[\\w-]+\\.[a-z]{2,4}$";  // Basic email validation
        // Regex pattern for password validation (requires at least one uppercase letter)
        ...
        if (email.equals("")) {
            ...
            JOptionPane.showMessageDialog(this, "Password must be at least 8 characters long, \ncontain at least one uppercase letter, \none digit, and one special character.", "Invalid Password", JOptionPane.ERROR_MESSAGE);
        // Proceed to authenticate the user
        } /*else if (loginService.authenticateUser(email, password, role)) {  
